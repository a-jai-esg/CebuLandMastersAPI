    ...
    if file and file.filename.endswith(".xlsx"):
        ...
        try:
            ...
            if year == "2020":
                ...
                cli_operating_expenses_depreciation_and_amortization = sheet[
                    "C34"
                ].value
                ...
                cli_operating_expenses_representation_and_entertainment = sheet[
                    "C44"
                ].value
                cli_operating_expenses_salaries_and_employee_benefits = sheet[
                    "C45"
                ].value
                cli_operating_expenses_security_and_janitorial_services = sheet[
                    "C46"
                ].value
                cli_operating_expenses_subscription_and_membership_dues = sheet[
                    "C47"
                ].value
                ...
                blcbp_operating_expenses_depreciation_and_amortization = sheet[
                    "G34"
                ].value
                ...
                blcbp_operating_expenses_professional_and_legal_fees = sheet[
                    "G41"
                ].value
                ...
                blcbp_operating_expenses_salaries_and_employee_benefits = sheet[
                    "G45"
                ].value
                ...
                blcbp_interest_expense_on_defined_benefit_obligation = sheet[
                    "G72"
                ].value
                ...
                blcbp_gpm = round(
                    (blcbp_total_gross_profit / blcbp_total_revenue) * 100
                )
                ...
                yes_operating_expenses_depreciation_and_amortization = sheet[
                    "H34"
                ].value
                ...
                yes_operating_expenses_representation_and_entertainment = sheet[
                    "H44"
                ].value
                yes_operating_expenses_salaries_and_employee_benefits = sheet[
                    "H45"
                ].value
                yes_operating_expenses_security_and_janitorial_services = sheet[
                    "H46"
                ].value
                yes_operating_expenses_subscription_and_membership_dues = sheet[
                    "H47"
                ].value
